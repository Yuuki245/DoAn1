...
namespace truyenchu.Migrations
{
    ...
    [Migration("20250627135210_AddReadingHistoryTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("truyenchu.Areas.Identity.Models.UserStory.UserStory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("truyenchu.Areas.ViewStory.Models.ReadingHistory.ReadingHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("LatestReading")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("truyenchu.Areas.Identity.Models.UserStory.UserStory", b =>
                {
                    ...
                    b.HasOne("truyenchu.Models.AppUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
